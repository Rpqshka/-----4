...
SELECT * FROM (SELECT 'Alex', '$apr1$a/dwz7pt$QCQtp.jkFJU1PiXEMwxKb0') AS tmp
WHERE NOT EXISTS (
    SELECT name FROM users WHERE name = 'Alex' AND password= '$apr1$a/dwz7pt$QCQtp.jkFJU1PiXEMwxKb0'
) LIMIT 1;
